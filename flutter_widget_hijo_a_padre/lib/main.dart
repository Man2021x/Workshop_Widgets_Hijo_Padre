  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        ElevatedButton(
          onPressed: () {
            // Aquí envía un nuevo mensaje al padre usando el callback
            onMessageChange("¡Mensaje actualizado desde el widget hijo!");
          },
        ...
        ElevatedButton(
          onPressed: () {
            // Aquí envía un nuevo mensaje diferente al padre usando el callback
            onMessageChange("¡Mensaje cambiado a algo diferente!");
          },
          child: const Text("Cambiar Mensaje a Diferente"),
        ),
      ],
    );
  }
